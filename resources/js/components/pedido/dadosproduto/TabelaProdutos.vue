            ...
            <table>
                ...
                <tbody>
                    <tr v-for="(dados, i) in listaDeProdutos" :key="i">
                        <td>{{ dados.nome }}</td>
                        <td>{{ Number(dados.qtde).toFixed(2) | colocarvirgula }}</td>
                        <td>{{ Number(dados.valor).toFixed(2) | colocarvirgula }}</td>
                        <td>{{ Number(dados.desconto).toFixed(2) | colocarvirgula }}</td>
                        <td>{{ Number(dados.acrescimo).toFixed(2) | colocarvirgula }}</td>
